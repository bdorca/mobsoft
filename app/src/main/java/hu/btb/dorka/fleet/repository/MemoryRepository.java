...
public class MemoryRepository implements Repository {
    ...
    public void open(Context context) {
        Car car1 = new Car(1L,1,"abc-123", "toyota", new Coordinate(45f, 15f),100,Car.StatusEnum.RUNNING);
        Car car2 = new Car(2L,2,"def-456", "bmw", new Coordinate(45f, 15.5f),50,Car.StatusEnum.STOPPED);
        Car car3 = new Car(3L,3,"ghi-789", "skoda", new Coordinate(10f, 15.5f),75, Car.StatusEnum.TURNED_OFF);
        cars=new ArrayList<>();
        cars.add(car1);
        cars.add(car2);
        cars.add(car3);
